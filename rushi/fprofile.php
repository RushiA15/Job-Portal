<?php
  session_start();
  $_SESSION["email"]= "rushi@gmail.com";
  $_SESSION["user_id"] = "1";
...
<html lang="en">
  <head>
    ...
    <title>NaukriDekho - A Job Portal for Employment Traceability</title>
    <!-- Bootstrap -->
    <link
...
<?php
    ...
    $gender = "M";
    $email = "007rushikeshav@gmail.com";
    // $email = $_SESSION["email"];
    $phoneno = "9142505304";
    ...
    $sql_jobs = "SELECT * FROM job , jobapplication  WHERE job.job_id = jobapplication.job_id AND u_id = '$u_id';";
                      ...
                      <div class="col-md-6 mb-2 d-flex align-items-center">
                        ...
                        <div class="form-outline datepicker w-100">
                          ...
                          <input type="text" class="form-control form-control-lg font-color font-color"
                            name="birthdayDate" placeholder="DOB" id="birthdayDate" required disabled/>
                        </div>
                      </div>
